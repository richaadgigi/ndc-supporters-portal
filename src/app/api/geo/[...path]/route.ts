...
const TARGET = (process.env.NEXT_PUBLIC_GEO_API_URL || process.env.GEO_API_URL || '').replace(/\/+$/, '');
const API_KEY = process.env.NEXT_PUBLIC_GEO_API_KEY || process.env.GEO_API_KEY || '';
const USERNAME = process.env.NEXT_PUBLIC_GEO_API_USERNAME || process.env.GEO_API_USERNAME || '';
